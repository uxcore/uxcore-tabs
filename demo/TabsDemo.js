    ...
    render(){
        return (
            <div>
                ...
                <h2>tab的位置</h2>
                <Select value={this.state.tabBarPosition} style={{width:200}} onChange={this.changeTabPosition.bind(this)}>
                ...
                <div style={{width: 550, height: 300}}>
                  <Tabs defaultActiveKey="2" onChange={callback} className="test"  tabBarPosition={this.state.tabBarPosition}>
                    <TabPane tab="tab 1" key="1">选项卡一</TabPane>
                    <TabPane tab="tab 2" key="2">选项卡二</TabPane>
                    <TabPane tab="tab 3" key="3">选项卡三</TabPane>
